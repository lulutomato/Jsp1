...
컨텍스트(context) : /jsp1			//이클립스에서 프로젝트 이름으로 기본으로 설정합니다.
클라이언트 ip :192.168.30.8
클라이언트 host : 192.168.30.8
클라이언트 포트 : 58691				// 클라이언트에서 요청을 보내는 포트(임의값)
서버 ip :192.168.30.254
서버 Name : DESKTOP-HUJUVSS
서버 포트 : 8088				//서버의 특정 서비스 진입하는 호트 
-->
</body>
</html>