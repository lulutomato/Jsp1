...
<body>
	<h3>JSTL 태그라이브러리 테스트</h3>
	 ...
	 <p>태그 라이브러리는 맨 위 지시자에서 정의하고 사용합니다. EL 기호는 애트리뷰트 값만 출력할 수 있습니다. }</p>
	 <% String name = "sana"; %>
	 <hr>
	...
	<!--if ~ else 형식 -->
	<h5>c:choose 테스트</h5>
	<c:set var="age" value="18"/> <!--애트리뷰트 age 값 변경하기  -->
	<c:choose>
	 <c:when test="${age<20}" >
	 <div style="color:green">청소년 입니다.</div>
		</c:when>
