...
<!-- jsp는 서버측에서 컴파일 되고 실행이 됩니다.
 ...
 <!--이클립스는 jsp 에 대한 소스파일이 여기에 있습니다
 	ㄴ D:\class20231228\workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\Jsp1\org\apache\jsp
    실제 환경에서는 tomcat 폴더 안에서 바로 찾을 수 있습니다.
    
    이클립스에서는 webapp 폴더에 저장된 파일들은 jsp 제외하고 여기에 있습니다.
    ㄴD:\class20231228\workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\
